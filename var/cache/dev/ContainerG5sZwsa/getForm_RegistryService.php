...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['App\\Form\\FormmedecinType' => function () {
    return ($this->privates['App\\Form\\FormmedecinType'] ?? $this->load('getFormmedecinTypeService.php'));
}, 'App\\Form\\FormserviceType' => function () {
    return ($this->privates['App\\Form\\FormserviceType'] ?? ($this->privates['App\\Form\\FormserviceType'] = new \App\Form\FormserviceType()));
}, 'App\\Form\\FormspecialiteType' => function () {
    return ($this->privates['App\\Form\\FormspecialiteType'] ?? ($this->privates['App\\Form\\FormspecialiteType'] = new \App\Form\FormspecialiteType()));
