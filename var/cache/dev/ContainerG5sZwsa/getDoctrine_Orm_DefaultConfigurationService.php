...
$instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(['App\\Repository\\MedecinsRepository' => function () {
    return ($this->privates['App\\Repository\\MedecinsRepository'] ?? $this->load('getMedecinsRepositoryService.php'));
}, 'App\\Repository\\ServicesRepository' => function () {
    return ($this->privates['App\\Repository\\ServicesRepository'] ?? $this->load('getServicesRepositoryService.php'));
}, 'App\\Repository\\SpecialitesRepository' => function () {
