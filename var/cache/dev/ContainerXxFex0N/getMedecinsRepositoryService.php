...
// Returns the private 'App\Repository\MedecinsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MedecinsRepository.php';

return $this->privates['App\\Repository\\MedecinsRepository'] = new \App\Repository\MedecinsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
